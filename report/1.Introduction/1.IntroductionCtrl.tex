...
During a sprint, each group were to send one representative to a weekly scrum stand up, so that all the groups knew what each other were doing. 
...
In our group we would also follow the scrum guidelines in order to produce a better product with a higher degree of agility in anticipation of changing requirements from the costumers. Hence the name Scrum of Scrums, as we had multiple scrums processes running independent of each other.
...
All group members were interested in maintaining and upgrading the projects server infrastructure to accommodate the needs of the other project groups and the users of the system. 
...
One group chose to take on the role as product owner and where to establish a relation with the costumers as quickly as possible. 
