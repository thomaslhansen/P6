...
Hence the Giraf project is only loosely based on the Scrum method, where Giraf uses most of the elements, the individual groups tried different working methods internally, e.g., our group used the Waterfall model, 
...
The project was previously written with a C\texttt{\#} WEB-API and an android application written in Xamarin, but due to the high amount of developers working from a Linux based operating system, this became a problem. 
...
This was from the costumers point of view, a large annoyance which should be resolved as quickly as possible. 
