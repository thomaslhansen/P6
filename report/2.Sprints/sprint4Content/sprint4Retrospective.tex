...
Despite not being able to make practical use of the feedback, from this retrospective, we still had the meeting, as we believed that it could be a benefit to our own experience, the readers of the report, and the next Giraf project.
...
Our group was in agreement with the the comments to the process, we only felt some small irritation with the timing of the standup meetings, as it was sometimes in the middle of our work. However, this is not easy to avoid as each group did not work on the exact same time schedule.
