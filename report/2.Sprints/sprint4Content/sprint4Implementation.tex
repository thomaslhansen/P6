...
\figur{1}{images/DockerImagesBothSDKandHosting.png}{Image showing the current Docker Images form \href{https://cloud.docker.com/u/giraf/repository/docker/giraf/web-api/tags}{Docker Hub}}{FIG:DockerHubImagesOverview}
