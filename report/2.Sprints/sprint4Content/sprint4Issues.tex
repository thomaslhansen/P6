...
Seeing as this group previously worked on the appbar, making a password confirmation prompt when going from citizen mode to guardian mode, our assigned issue for sprint 4 (\href{https://github.com/aau-giraf/weekplanner/issues/121}{Issue \texttt{\#}121}) also had its ties to the appbar:
