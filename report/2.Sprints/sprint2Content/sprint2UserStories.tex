...
Once the issue was correctly understood by the group and any uncertainties was cleared with the product owner group, the actual implementation of the issues could begin. 
