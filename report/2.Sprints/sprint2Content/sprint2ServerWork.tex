...
The servers Master00 and Master01 were setup as Swarm Managers. 
On each server, Docker Community Edition was installed, and the master servers have been added as Swarm Managers. 

Once each server has been added to the Docker Swarm, the command $docker node ls$ can be run to check the status of the Docker Swarm.
