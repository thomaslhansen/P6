...
\figur{0.2}{images/changeToGuardian.pdf}{Icon for changing from citizen mode to guardian mode}{changeToGuardianIcon}
\figur{1}{images/citizenToGuardianPassScreen.png}{Prototype for confirming password}{confirmPassScreenProto}

\todo{show icon for the other way around as well, and be explicit on its function}
