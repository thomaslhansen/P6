...
Flutter is a UI framework developed by Google, which is able to compile into native Android and IOS code which makes the app work at native speeds at both platforms. 
